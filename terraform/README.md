...
| <a name="input_mssql_max_gb"></a> [mssql\_max\_gb](#input\_mssql\_max\_gb) | The max size of the database in gigabyte | `number` | `10` | no |
...
| <a name="input_mssql_sku_name"></a> [mssql\_sku\_name](#input\_mssql\_sku\_name) | Specifies the name of the SKU used by the database | `string` | `"S0"` | no |
