...
using Dfe.Academies.Academisation.IService.ServiceModels.Legacy.Extensions;
...
namespace Dfe.Academies.Academisation.IService.ServiceModels.Legacy.ProjectAggregate
{
	public class LegacyProjectServiceModel : IEquatable<LegacyProjectServiceModel>
	{
		public LegacyProjectServiceModel(int Id,
										 ...
										 decimal? ConversionSupportGrantAmount =
											 null, // had to make this nullable or move it to the top
										 ...
										 ICollection<ProjectNote>? Notes = null)
		{
			...
			this.PercentageOfGoodOrOutstandingSchoolsInTheDiocesanTrust =
			...
			this.DistanceFromSchoolToTrustHeadquartersAdditionalInformation =
			...
			this.Notes = Notes.ToProjectNoteServiceModels().ToList();
		}
		...
		public void Deconstruct(out int Id,
								...
								out decimal?
									ConversionSupportGrantAmount, // had to make this nullable or move it to the top
