...
public interface IConversionProjectRepository : IRepository<Project>, IGenericRepository<Project>
{
	...
	Task<IEnumerable<IProject>> GetConversionProjectsByIdsAsync(IEnumerable<int> ids, int? projectGroupId = null, CancellationToken cancellationToken = default);
...
IEnumerable<string>? states, string? title, IEnumerable<string>? deliveryOfficers, IEnumerable<string>? regions, IEnumerable<string>? localAuthorities, IEnumerable<string>? advisoryBoardDates);
	...
	Task<IEnumerable<IProject>> GetConversionProjectsByProjectGroupIdsAsync(IEnumerable<int?> ids, CancellationToken cancellationToken);
