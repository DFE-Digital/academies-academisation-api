const AuthorisedUserCannotUpdatePreviousFinancialYearEndDateToInvalidDateBodyPayload = {
    "applicationId": 24,
   ...
   module.exports = {AuthorisedUserCannotUpdatePreviousFinancialYearEndDateToInvalidDateBodyPayload}