const AuthorisedUserCannotUpdateSacreExemptionEndDateToInvalidDateBodyPayload = {
    "applicationId": 24,
   ...
   module.exports = {AuthorisedUserCannotUpdateSacreExemptionEndDateToInvalidDateBodyPayload}