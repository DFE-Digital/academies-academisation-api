const AuthorisedUserCannotUpdateNextFinancialYearEndDateToInvalidDateBodyPayload = {
    "applicationId": 24,
   ...
   module.exports = {AuthorisedUserCannotUpdateNextFinancialYearEndDateToInvalidDateBodyPayload}