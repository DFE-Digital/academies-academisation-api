const AuthorisedUserCannotUpdateWorksPlannedDateToInvalidDateBodyPayload = {
     "applicationId": 24,
   ...
   module.exports = {AuthorisedUserCannotUpdateWorksPlannedDateToInvalidDateBodyPayload}