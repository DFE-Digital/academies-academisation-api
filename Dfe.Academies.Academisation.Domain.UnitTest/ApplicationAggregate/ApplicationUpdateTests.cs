		...
		for (int i = 0; i < numberOfSchools; i++)
		{
			...
			var schoolToAdd = new School(ms.Id, ms.TrustBenefitDetails, ms.OfstedInspectionDetails,
				...
				new SchoolDetails(ms.Details.Urn, ms.Details.ProposedNewSchoolName!, ms.Details.LandAndBuildings,
					...
					ms.Details.ContactHeadName, _faker.Internet.Email(),
					ms.Details.ContactChairName, _faker.Internet.Email(), 
					ms.Details.ContactRole, ms.Details.MainContactOtherName,
					_faker.Internet.Email(), ms.Details.MainContactOtherRole,
	...
	public class SchoolDetailsBuilder
	{
		...
		public SchoolDetails Build()
		{
			return new SchoolDetails(
				...
				_contactHeadEmail, _defaultSchoolDetails.ContactChairName,
				_chairEmail,
				...
				_defaultSchoolDetails.SchoolSupportGrantJoiningInAGroup, _defaultSchoolDetails.SchoolSupportGrantBankDetailsProvided,
				_defaultSchoolDetails.SchoolsInGroup,
