...
{
	public class CreateProjectGroupCommand(string trustName, string trustReferenceNumber, string trustUkprn, List<int> conversionProjectIds) : IRequest<CreateResult>
	{
