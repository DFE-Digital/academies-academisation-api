...
namespace Dfe.Academies.Academisation.Service.Commands.CypressData
{
	...
	public class CyNewPlusEditDeclinedDecisionCommand : CypressDataCommandAbstractBase, IRequest<CommandResult>
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CyNewPlusEditDeclinedDecisionCommand"/> class.
		/// </summary>
		/// <param name="id">The id.</param>
		/// <param name="date">The date.</param>
		public CyNewPlusEditDeclinedDecisionCommand(string id, DateTime date)
		{
			Id = id;
			Date = date;
