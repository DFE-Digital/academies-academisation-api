...
namespace Dfe.Academies.Academisation.Service.Commands.CypressData
{
	...
	/// </summary>
	public class CyAddFAMProjectFromA2BCommandHandler : CypressDataBaseCommandHandlerAbstractBase,
		IRequestHandler<CyAddFAMProjectFromA2BCommand, CommandResult>
	{

		/// <summary>
		///     Initializes a new instance of the <see cref="CyAddFAMProjectFromA2BCommandHandler" /> class.
		/// </summary>
		/// <param name="dbContext">The db context.</param>
		public CyAddFAMProjectFromA2BCommandHandler(AcademisationContext dbContext) : base(dbContext)
		{
		}
		...
		public async Task<CommandResult> Handle(CyAddFAMProjectFromA2BCommand request, CancellationToken cancellationToken)
		{
			// Define the project name
			string projectName =  "Fahads Cypress FAM test";
			...
			var formAMatProjectId = 7983;

			// Create a new project
			var projectDetails = new ProjectDetails
			{
				Urn = 113537,
				ApplicationReferenceNumber = "A2B_124381",
				...
				ProposedAcademyOpeningDate = now,
			...
			var parameters = new SqlParameter[]
			{
				...
				new SqlParameter("@ProposedAcademyOpeningDate", projectDetails.ProposedAcademyOpeningDate),
				...
				new SqlParameter("@IsFormAMat", projectDetails.IsFormAMat),
				new SqlParameter("@FormAMatProjectId", formAMatProjectId)
			};
