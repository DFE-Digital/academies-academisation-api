...
internal static class LegacyProjectServiceModelMapper
{
	...
	internal static MATProjectServiceModel MapToMATServiceModel(this IProject project)
	{
		MATProjectServiceModel serviceModel = new(project.Id, project.Details.Urn)
		{
			IfdPipelineId = project.Details.IfdPipelineId,
			SchoolName = project.Details.SchoolName,
			CreatedOn = project.CreatedOn,
